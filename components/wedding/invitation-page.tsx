...
export function InvitationPage() {
  ...
  const fallbackData = useMemo<WeddingData>(() => {
    return getFallbackWeddingData(guestName) ?? weddingData
  }, [guestName])
  ...
  const coverData = publicData ?? fallbackData
  ...
  return (
    <main className="vintage-public-page relative isolate min-h-screen overflow-hidden bg-[#1f120c]">
      ...
      <FloatingMusicButton active={opened} data={coverData} />
